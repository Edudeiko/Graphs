...
- What are my edges? aka when is there an edge, when is a node connected to
another node? When not?
​
...
​
​
0. Spot that we might use a graph: "shortest transformation sequence" is a lot
like shortest path
​
1. Describe the problem using graphs terminology
- What are my nodes here?
...
--- letters??
​
- What are my edges? aka when is there an edge, when is a node connected
to another node? When not?
​
